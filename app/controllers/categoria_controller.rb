class CategoriaController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.json{render :json => @categoria.to_json(:only =>[:id,:nombre,:descripcion] ,:methods => [:imagen_url_thumbnail,:imagen_url_medium,:imagen_url_large])}
    end
  end
  ...
  private
    ...
    def categorium_params
      params.require(:categorium).permit(:nombre, :descripcion, :imagen)
    end
end
